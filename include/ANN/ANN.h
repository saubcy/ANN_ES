...
DLL_API ANNpointArray annAllocPts_ES(
		ES_INFO*   		es_info,
		int				n,			// number of points
		int				dim);		// dimension
...
public:
	...
	void set_fix_len(unsigned int fix_len);

	void set_g_value(ANNpoint es_value);
	void get_value_by_index(unsigned int index);
